...
import com.pharmacy.health_plus.services.AppUserService;
...
public class AccountController {
    ...
    public String register(Model model, @Valid @ModelAttribute RegisterDto registerDto, BindingResult result){
        ...
        if(registerDto.getPhone().length()>10){
            result.addError(new FieldError("registerDto","phone","Phone number must be 10 digits—remove the extra digits!"));
        }
        ...
        try{
            ...
            newUser.setRole("Registered Customer");
